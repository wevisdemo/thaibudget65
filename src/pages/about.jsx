    ...
    <WvContainer heading="เกี่ยวกับโครงการ">
      <WvParagraphGroup heading="เป้าหมาย">
        ...
        <p>
          ...
          แปลงเอกสารงบประมาณทั้งหมดกว่า 25 เล่ม และ กว่า 9,000 หน้า
          มาเป็นในรูปแบบ CSV หรือ Excel เพื่อมาแจกประชาชนทุกคน และ
          ผู้แทนราษฎรจากทุกพรรค
      ...
      <WvParagraphGroup small heading="สืบค้นและรวบรวมข้อมูล">
        <p>
          ร่วมกับ{' '}
          <ExternalLink href="https://github.com/kaogeek">GaoGeek</ExternalLink>{' '}
      ...
      <WvParagraphGroup heading="ที่มาของข้อมูล">
        <p>
          <ExternalLink href="https://www.bb.go.th/topic3.php?catID=1377&gid=860&mid=544">
            ร่างพระราชบัญญัติงบประมาณรายจ่าย ประจำปีงบประมาณ พ.ศ. 2566
            โดยสำนักงบประมาณ
          </ExternalLink>
        </p>
      </WvParagraphGroup>
